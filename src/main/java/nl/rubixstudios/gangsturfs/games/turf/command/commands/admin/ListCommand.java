...
public class ListCommand extends SubCommand {
    ...
    public ListCommand() {
        super("list", Collections.singletonList("lis"), "gangmt.turf.admin", true);
    ...
    public void execute(CommandSender sender, String[] args) {
        if (args.length != 0) {
            sender.sendMessage(Language.TURF_PREFIX + "Usage: /turf list ");
            return;
        }
        ...
        player.sendMessage(Color.translate("&e&lTurfs List: "));
